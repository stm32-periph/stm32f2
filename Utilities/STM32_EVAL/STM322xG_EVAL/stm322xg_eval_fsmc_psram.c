/**
  ******************************************************************************
  * @file    stm322xg_eval_fsmc_psram.c
  * @author  MCD Application Team
  * @version V5.1.3
  * @date    31-September-2021
  * @brief   This file provides a set of functions needed to drive the IS66WV25616BLL
  *          PSRAM memory mounted on STM322xG-EVAL evaluation board(MB786) RevA.
  *  
...
/* Includes ------------------------------------------------------------------*/
#include "stm322xg_eval_fsmc_psram.h"
...
/** @addtogroup STM322xG_EVAL_FSMC_PSRAM
  ...
  *             IS66WV25616BLL PSRAM memory mounted on STM322xG-EVAL board.
  * @{
  */ 

/** @defgroup STM322xG_EVAL_FSMC_PSRAM_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM322xG_EVAL_FSMC_PSRAM_Private_Defines
  * @{
  */ 
/** 
...
/** @defgroup STM322xG_EVAL_FSMC_PSRAM_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM322xG_EVAL_FSMC_PSRAM_Private_Variables
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM322xG_EVAL_FSMC_PSRAM_Private_Function_Prototypes
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM322xG_EVAL_FSMC_PSRAM_Private_Functions
  * @{
  */ 
