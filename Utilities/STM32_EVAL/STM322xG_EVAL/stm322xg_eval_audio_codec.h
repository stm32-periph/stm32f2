...
#include "stm322xg_eval_ioe.h" /* IOExpander driver is included in order to allow 
...
/* Uncomment the following line to use the default Codec_TIMEOUT_UserCallback() 
   function implemented in stm322xg_eval_audio_codec.c file.
...
/** @defgroup STM322xG_EVAL_AUDIO_CODEC_Exported_Functions
  * @{
  */ 
...
/* Codec_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm322xg_eval_audio_codec.h file.
   Typically the user implementation of this callback should reset I2C peripheral
   and re-initialize communication or in worst case reset all the application. */
uint32_t Codec_TIMEOUT_UserCallback(void);
 
#endif /* __STM322xG_EVAL_AUDIOCODEC_H */
